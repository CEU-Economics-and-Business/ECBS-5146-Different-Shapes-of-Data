...
**ANALYTICAL LAYER:** Design a denormalized data structure based on your operational layer. Create the tables in MySQL for this structure. 
...
For the rest, I will give you the freedom of choosing naming conventions and structure, unless it was covered implicitly in the course (Database modeling and documenting with Enhanced Entity-Relationship (EER) diagrams or Analytical layer modeling and documentation using Star Schema). Yet, I would encourage you, to find some reading over the internet and whatever you choose, be consistent and commens of coding convensions.  
