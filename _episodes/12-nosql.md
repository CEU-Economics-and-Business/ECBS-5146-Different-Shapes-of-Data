...
#### Exercise interface: [http://52.19.139.82:8081/solr/#/flightdelays/query](http://52.19.139.82:8081/solr/#/flightdelays/query)
...
```
http://52.19.139.82:8081/solr/flightdelays/select?q=*:*
```
{: .output}
...
```
http://52.19.139.82:8081/solr/flightdelays/select?fl=DISTANCE,ORIG_CITY,DEST_CITY&q=TAIL_NUMBER:N838UA AND DATE:[NOW-10YEARS TO *]&sort=DISTANCE desc&rows=5
```
{: .output}
...
```
http://52.19.139.82:8081/solr/flightdelays/select?fl=TAIL_NUMBER&q=TAIL_NUMBER:?8???a
```
{: .output}
...
```
http://52.19.139.82:8081/solr/flightdelays/select?fl=DEST_CITY&q=DEST_CITY:kolumbas~2
```
{: .output}
...
```
http://52.19.139.82:8081/solr/flightdelays/select?q=DEST_CITY:Boise~3&facet.field=DEST_CITY_str&facet=on&rows=0
```
{: .output}
...
```
http://52.19.139.82:8081/solr/flightdelays/select?d=2&facet.field=ORIG_CITY_str&facet=on&fl=ORIG_CITY,ORIG_LOCATION_p,&fq={!geofilt}&pt=39.85,-104.66&q=*:*&sfield=ORIG_LOCATION_p
```
{: .output}
